...
class Student_system:
    ...
    def __init__(self,root):
       ...
       #To insert Menu in Window
        ...
        fileMenu.add_command(label="Books Entry")

        
        fileMenu.add_separator()
        #It is used to add the separator line to the menu.
        fileMenu.add_command(label="jnnj")
        ...
        #**************Manage Frame**********************
        """Manage_frame=Frame(self.root,relief=RIDGE,bg="pink")
        Manage_frame.place(x=20,y=100,width=400,height=540)"""


                
        """m_title=Label(self.root,text="    Manage Student    ",bg="pink",fg="black",font=("algerian",25,"bold"))
        m_title.place(x=700,y=300,width=60,height=3)"""
        ...
        lbl_email=Label(self.root,text="Email",bg="pink",fg="black",font=("times new roman",15,"bold"))
        ...
        self.txt_addr=Text(self.root,width=19,height=3)
        ...
        Detail_frame.place(x=610,y=340,width=690,height=340)"""


        """img1=PhotoImage(file="gradehat.png")
        labelimage=Frame(self.root,image=img1,background="#ffffff",)
        labelimage.place(x=900,y=100,width=220,height=160)"""

        self.pic = ImageTk.PhotoImage(file="gradehat.png")#(for image in main(app) page)
    ...
    def add_student(self):
            ...
            con=pymysql.connect(host='localhost',user='root',password='nishayadav',database='stm4')
            cur=con.cursor()
