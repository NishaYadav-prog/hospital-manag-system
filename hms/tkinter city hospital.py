...
b2=Button(root,text=  " Appointment       ",font=("arial 20 bold",15,"bold"),bd=0,bg='white',command=apoint).place(x=380,y=240)
b3=Button(root,text=  "   List of Doctors  ",font=("arial 20 bold",15,"bold"),bd=0,bg='white',command=lst_doc).place(x=120,y=430)
b4=Button(root,text=  "Services available",font=('arial 20 bold',15,"bold"),bd=0,bg='white',command=ser_avail).place(x=380,y=430)
b5=Button(root,text=  "Modify data       ",font=('arial 20 bold',15,"bold"),bd=0,bg='white',command=mod_sub).place(x=620,y=240)
b6=Button(root,text=  "        Exit     ",font=('arial 20 bold',15,"bold"),bd=0,command=root.destroy,bg='white').place(x=620,y=430)
       

img1=PhotoImage(file="docto2.png")
...
labelimage.place(x=390,y=110)

img2=PhotoImage(file="registration.png")
...
labelimage.place(x=150,y=120)
img3=PhotoImage(file="listof.png")
...
labelimage.place(x=140,y=307)
img4=PhotoImage(file="exist.png")
...
labelimage.place(x=620,y=300)
img5=PhotoImage(file="service.png")
...
labelimage.place(x=390,y=300)

img6=PhotoImage(file="modifydate1.png")
